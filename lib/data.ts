...
export const SERVICES_DATA: ServiceItem[] = [
  ...
  },
  {
    ...
    shortDesc: "Reliable container transport with professional handling and seamless coordination for domestic and international shipments.",
    fullDesc: "Container Logistics Solutions: Delivering reliable, safe, and time-critical container transportation, drayage, and depot management services tailored to support seamless industrial logistics.",
    iconName: "Container",
    features: [
